...
/****** Plans:
 * alt position
 * space/esc/tab modifier
 * shift/viiva
 * gui+numberlayer
 * full row number
 * raise and lower tap to ' or ~ for example
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KEYMAP(
         ...
         KC_TRNS, RALT(KC_NUBS), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RALT(KC_7), RALT(KC_0), KC_TRNS, KC_SLSH, KC_TRNS, 
   ...
   KEYMAP(
         ...
         KC_TRNS, BL_TOGG, BL_STEP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_TRNS, KC_VOLU, KC_TRNS, 
